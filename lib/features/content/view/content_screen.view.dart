...
class _ContentScreenState extends ConsumerState<ContentScreen> {
  ...
  Future<void> shareContent(BuildContext context) async {
    ...
    if (imageUrl.startsWith('http')) {
      ...
      await SharePlus.instance
          .share(ShareParams(files: [XFile(imageUrl)], text: text));
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor:
            theme == darkTheme ? Color(0xFF585858) : const Color(0xFFDA8E0B),
        leading: IconButton(
          icon: const Icon(
            Icons.dashboard,
            color: Colors.white,
      ...
      drawer: AnnotatedRegion<SystemUiOverlayStyle>(
        value: SystemUiOverlayStyle(
          statusBarColor:
              theme == darkTheme ? Color(0xFF585858) : Color(0xFFDA8E0B),
        ),
        child: Drawer(
          backgroundColor:
              theme == darkTheme ? Color(0xFF2A2A2A) : Colors.white,
          child: ListView(
            children: <Widget>[
